...
module cmplx_mul_channel_est (
    ...
    /*
        ...
        let Rx = i_ar+j*i_ai,     Locally generated = i_br+j*i_bi
        divison is implemented as multiplying by conjugate so 
        output = (i_ar+i_ai)(i_br-i_bi)
        real        = i_ar.i_br + i_ai.i_bi  
        imaginary   = i_ai.i_br - i_ar.i_bi   
    */
    ...
    begin
            ...
            // Result
            // range is from 26:11 instead of 25:10 to get the i_bits shifted right by 1
            // this shift implement the divided by 2 needed for taking the average
            r_resR = r_arbr[26:11] + r_aibi[26:11];     
            r_resI = r_aibr[26:11] - r_arbi[26:11]; 
    end
