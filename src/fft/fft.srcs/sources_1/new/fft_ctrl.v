...
always @(r_currentState_BF1 or r_cycleCounter or fftEn or r_addGen1)
begin
...
begin
      case(r_currentState_BF2)
            ...
            bufferState:    begin
                                if (r_cycleCounter >= 28)
                                    r_nextState_BF2 = rstnState;
                                else if(r_addGen2 < 4)
                                    r_nextState_BF2 = bufferState;
                                else if (r_addGen2 >= 4 && r_addGen2 < 8)
                                     r_nextState_BF2 = activeState;
                                else if (r_addGen2 >= 8 && r_addGen2 < 12)
                                     r_nextState_BF2 = bufferState;
                                else 
...
begin
        case(r_currentState_BF2)
            ...
            bufferState:    begin
                                ...
                                s3 = 0;
                                if (r_addGen2 < 4)
                                    sdf_2_addr = r_cycleCounter;
                                else
                                    sdf_2_addr = r_cycleCounter - 8;
                            end
                            
            activeState:    begin
                                s2 = 0;
                                s3 = 1;
                                sdf_2_addr = r_cycleCounter - 4;
                            end
                            
            activeStateJ:   begin
                                s2 = 1;
                                s3 = 1;
                                sdf_2_addr = r_cycleCounter - 12;
                            end
...
always @(r_currentState_BF3 or r_cycleCounter or r_addGen1)
begin
        case(r_currentState_BF3)
            rstnState:      begin
                                s4 = 0;
            ...
            bufferState:    begin
                                s4 = 0;
                                sdf_3_addr = r_cycleCounter;
                            end
                            
            activeState:    begin
                                s4 = 1;
                                sdf_3_addr = r_cycleCounter - 2;
                            end
...
begin
    if (r_cycleCounter < 16)
        fftValid = 0;
    else if (r_cycleCounter >= 16 && r_cycleCounter < 31)
        fftValid = 1;
    else
        fftValid = 0;
end
